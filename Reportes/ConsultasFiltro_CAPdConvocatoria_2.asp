...
<div align="center"><font color="#3CA0BD"><strong>CONVOCATORIAS</strong></font></div>
...
<!--- ---------------------------------------------------------------------------------------------------------------- 
 ...
 ---------------------------------------------------------------------------------------------------------------- --->
  ...
  <TR  > 
    ...
    <TD><input type = "button" value = "C u r s o s" name = "btnCursosrelacionados" onClick="location.href='DosFrames_2.asp?Id_CAPdConvocatoria=<%= Ob_RS2(Campo)%>'"> 
      <%Else
...
<INPUT TYPE="button" VALUE="Buscar un nuevo registro de convocatoria" ONCLICK="location.href='https://<%= IP_Servidor%>/carrerapgr/Reportes/CAP_Filtros_reportes.asp?var_Id_gcdmenus=2133&par_Id_menupadre=Convocatoria&par_Id_aplicacion=34'" >
