...
<% ' Asignación de los parametros a variables
  ...
  'response.write(par_ins_capacitadora)
   '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	...
	%>
<%
  Response.Write("LISTA DE  DE ASISTENCIA AL CURSO:   "+  ver_curso_seleccionado + "<br>")
  ...
  %>
	...
	<td width="101">Dia 1</td>
	                 
    <td width="97">Dia 2</td>
     
    <td width="84">Dia 3</td>
       
    <td width="85">Dia 4</td>
	  
    <td width="80">Dia 5</td>
    </tr>
    <% 
	NCont = 0
