...
<body bgproperties="fixed" background = "Multimedia/imagenes/softgri1.jpg">
...
<tr >
 <td><Center>
            <strong><font color="#3CA0BD" size="4">ACCESO A LA PANTALLA DE CAMBIO 
            DE PASSWORD </font></strong> 
          </Center></td>
    </tr>
</table>
</center>
...
function valida()
{
 ...
 if (document.in_passsw.txtContrasena.value == '')
      {
	  alert("El campo: Password, no puede enviarse vacio, verifique por favor")
	  return;
	  }
//-----------------------------------
