...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
    %>
    <TABLE   class="SL" border="1"  HEIGHT='349' width="531">
     <TR>
...
<!--          <SELECT NAME='Id_CARcDir_o_subsede' SIZE=1 >
    ...
    <% Ob_C3.CLOSE%>
	 ...
	 <TR> <BR>
	 <TD> Usuario: </TD>	 
	  <TD><input type="text" name="CARcUSR" VALUE="<%=CARcUSR%>" disabled></TD>
	 </TR>
	 	 <TR> 
		 	 <TD>Password : </TD>
...
<!--	     <SELECT NAME='Id_CARcPerfilGrupo' SIZE= 1 >
    ...
    <% Ob_RS2.CLOSE%>
	 ...
	 <TD><Input type="text" name="Descripcion_Usuario" size="40" VALUE="<%=Descripcion_Usuario%>"></TD>
	 </TR>
	 ...
	 <TD><Input type="text" name="Nombre" VALUE="<%=Nombre%>"></TD>
	  ...
	  <TR>
	 <TD>Micro de la persona responsable del usuario:</TD>
	 <TD><Input type="text" name="Micro" VALUE="<%=Micro%>"></TD>
	 </TR>
