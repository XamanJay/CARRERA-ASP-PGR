...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Consultas de  Paginas   </FONT>
    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Descripción de la Página</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='Descripcion' SIZE=10 ROWS=1 COLS=35><%=Descripcion%></TEXTAREA>
      </TD > 
     <TR>
      <TD>
        <B>Carpeta de alojamiento</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
