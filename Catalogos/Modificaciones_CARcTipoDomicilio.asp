...
v_Tabla = "CARcTipoDomicilio"
   ...
   consulta = "SELECT * FROM CARcTipoDomicilio WHERE Id_CARcTipoDomicilio ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoDomicilio= OB_RS("CARcTipoDomicilio")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoDomicilio.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Domicilio</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Domicilio  </FONT></h2>
     <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoDomicilio")  <> "" then  Ob_RS("CARcTipoDomicilio")=request("CARcTipoDomicilio") end if
    ...
    %>
 <TABLE width="455" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD> 
     </TR>
     <TR>
      <TD>
        <B>Tipo de domicilio  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoDomicilio' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcTipoDomicilio%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoDomicilio >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoDomicilio.value  == "")
  {
       alert("EL CAMPO: Tipo Domicilio, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoDomicilio.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo de Domicilio.");
       return false;
  }
