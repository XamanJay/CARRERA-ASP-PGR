...
v_Tabla = "CARcFormaCabello"
   ...
   consulta = "SELECT * FROM CARcFormaCabello WHERE Id_CARcFormaCabello ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcFormaCabello= OB_RS("CARcFormaCabello")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcFormaCabello.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Forma de Cabello </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>
	 Modificar  Forma de Cabello  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcFormaCabello")  <> "" then  Ob_RS("CARcFormaCabello")=UCASE(request("CARcFormaCabello")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Forma de cabello  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcFormaCabello' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcFormaCabello%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcFormaCabello >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcFormaCabello.value  == "")
  {
       alert("EL CAMPO: Forma de Cabello, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcFormaCabello.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Tabla Forma Cabello.");
       return false;
  }
