...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcTipoEstimulo.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Tipode Estimulo   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcTipoEstimulo")  <> "" then  Ob_RS("CARcTipoEstimulo")=UCASE(request("CARcTipoEstimulo")) end if
 ...
 <TABLE  border='1'   WIDTH='80%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Estimulo</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT'  style='text-transform: uppercase'  NAME='CARcTipoEstimulo' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcTipoEstimulo%>>
      </TD > 
     </TR>
</TABLE>
