...
v_Tabla = "CARcMenton"
   ...
   consulta = "SELECT * FROM CARcMenton WHERE Id_CARcMenton ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcMenton.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcMenton")  <> "" then  Ob_RS("CARcMenton")=UCASE(request("CARcMenton")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Ment&oacute;n  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcMenton' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcMenton%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcMenton >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcMenton.value  == "")
  {
       alert("EL CAMPO: Menton, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcMenton.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Mento.");
       return false;
  }
