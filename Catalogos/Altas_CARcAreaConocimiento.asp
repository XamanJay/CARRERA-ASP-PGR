...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcAreaConocimiento.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  &Aacute;rea de Conocimiento   </FONT>    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcAreaConocimiento")  <> "" then  Ob_RS("CARcAreaConocimiento")=UCASE(request("CARcAreaConocimiento")) end if
    ...
    %>
 <TABLE  border='1'   WIDTH='53%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="35%"> 
         <B>Catálogo de &aacute;rea de conocimiento</B>      </TD>
      <TD width="65%">
    ...
    <% Ob_RS2.CLOSE%>
     ...
     <TR>
      <TD>
        <B>&Aacute;rea de conocimiento</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='CARcAreaConocimiento' SIZE=10 ROWS=5 COLS=35 style="text-transform: uppercase"><%=CARcAreaConocimiento%></TEXTAREA>
      </TD > 
     </TR>
</TABLE>
