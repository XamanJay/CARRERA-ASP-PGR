...
v_Tabla = "CARcTipoDocumento"
   ...
   consulta = "SELECT * FROM CARcTipoDocumento WHERE Id_CARcTipoDocumento ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoDocumento= OB_RS("CARcTipoDocumento")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoDocumento.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Documento</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Documento  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoDocumento")  <> "" then  Ob_RS("CARcTipoDocumento")=ucase(request("CARcTipoDocumento")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de documento  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoDocumento' SIZE=30 MAXLENGTH=30 style="text-transform: uppercase" VALUE=<%= CARcTipoDocumento%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoDocumento >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoDocumento.value  == "")
  {
       alert("EL CAMPO: Tipo de Documento, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoDocumento.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo de Documento.");
       return false;
  }
