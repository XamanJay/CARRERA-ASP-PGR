...
v_Tabla = "CARcNivelEstudios"
   ...
   consulta = "SELECT * FROM CARcNivelEstudios WHERE Id_CARcNivelEstudios ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcNivelEstudios= OB_RS("CARcNivelEstudios")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcNivelEstudios.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Nivel de Estudios  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Nivel de Estudios  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcNivelEstudios")  <> "" then  Ob_RS("CARcNivelEstudios")=UCASE(request("CARcNivelEstudios")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Nivel de estudios</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcNivelEstudios' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcNivelEstudios%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcNivelEstudios >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcNivelEstudios.value  == "")
  {
       alert("EL CAMPO: Nivel de Estudios, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcNivelEstudios.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Nivel de Estudios.");
       return false;
  }
