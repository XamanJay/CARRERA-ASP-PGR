...
v_Tabla = "CARcCategoria"
   ...
   consulta = "SELECT * FROM CARcCategoria WHERE Id_CARcCategoria ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcCategoria= OB_RS("CARcCategoria")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcCategoria.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Categor&iacute;a  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Categor&iacute;a  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCategoria")  <> "" then  Ob_RS("CARcCategoria")=UCASE(request("CARcCategoria")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Categor&iacute;a<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='CARcCategoria' SIZE=10 ROWS=5 COLS=35 style="text-transform: uppercase"><%=CARcCategoria%></TEXTAREA>
  	<BR><BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcCategoria >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcCategoria.value  == "")
  {
       alert("EL CAMPO: Categoria, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcCategoria.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Categoria.");
       return false;
  }
