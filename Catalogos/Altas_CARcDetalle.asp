...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcDetalle.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  detalle de est&iacute;mulo y reconocimiento   </FONT>    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   WIDTH='35%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD width="60%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcDetalle' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcDetalle%>>
      </TD > 
     </TR>
     <TR>
      <TD> 
         <B>Tipo de est&iacute;mulo</B>
      </TD>
      <TD>
