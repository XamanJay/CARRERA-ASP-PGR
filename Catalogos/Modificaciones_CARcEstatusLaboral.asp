...
v_Tabla = "CARcEstatusLaboral"
   ...
   consulta = "SELECT * FROM CARcEstatusLaboral WHERE Id_CARcEstatusLaboral ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcEstatusLaboral= OB_RS("CARcEstatusLaboral")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEstatusLaboral.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Estatus Laboral  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Estatus Laboral  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEstatusLaboral")  <> "" then  Ob_RS("CARcEstatusLaboral")=UCASE(request("CARcEstatusLaboral")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Descripci&oacute;n de estatus</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEstatusLaboral' SIZE=30 MAXLENGTH=30 style="text-transform: uppercase" VALUE=<%= CARcEstatusLaboral%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEstatusLaboral >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcEstatusLaboral.value  == "")
  {
       alert("EL CAMPO: Descripcion Estatus, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcEstatusLaboral.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Estatus Laboral.");
       return false;
  }
