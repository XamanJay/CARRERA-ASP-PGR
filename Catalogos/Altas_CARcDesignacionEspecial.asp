...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcDesignacionEspecial.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  DesignacionEspecial   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcDesignacionEspecial")  <> "" then  Ob_RS("CARcDesignacionEspecial")=UCASE(request("CARcDesignacionEspecial")) end if
 ...
 <TABLE  border='1'   WIDTH='80%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Designación</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT style='text-transform: uppercase' TYPE='TEXT' NAME='CARcDesignacionEspecial' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcDesignacionEspecial%>>
      </TD > 
     </TR>
</TABLE>
