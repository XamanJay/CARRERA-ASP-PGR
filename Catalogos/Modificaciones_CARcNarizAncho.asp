...
v_Tabla = "CARcNarizAncho"
   ...
   consulta = "SELECT * FROM CARcNarizAncho WHERE Id_CARcNarizAncho ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcNarizAncho= OB_RS("CARcNarizAncho")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcNarizAncho.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcNarizAncho")  <> "" then  Ob_RS("CARcNarizAncho")=UCASE(request("CARcNarizAncho")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Ancho nariz  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcNarizAncho' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcNarizAncho%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcNarizAncho >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcNarizAncho.value  == "")
  {
       alert("EL CAMPO: Ancho Nariz, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcNarizAncho.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Ancho Nariz.");
       return false;
  }
