...
v_Tabla = "CARcCejas"
   ...
   consulta = "SELECT * FROM CARcCejas WHERE Id_CARcCejas ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcCejas.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCejas")  <> "" then  Ob_RS("CARcCejas")=UCASE(request("CARcCejas")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcCejas' SIZE=10 MAXLENGTH=10 style="text-transform: uppercase" VALUE=<%= CARcCejas%>>
      </TD > 
	  </TR>
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcCejas >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcCejas.value  == "")
  {
       alert("EL CAMPO: Cejas, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcCejas.value.search("[^0-9]")  == 0 ) 
  {
