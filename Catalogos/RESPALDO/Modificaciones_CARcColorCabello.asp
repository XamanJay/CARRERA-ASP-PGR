...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcColorCabello  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcColorCabello")  <> "" then  Ob_RS("CARcColorCabello")=request("CARcColorCabello") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Color de cabello:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcColorCabello' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcColorCabello%>>
		 <BR> <BR>
      </TD > 
</TABLE>
