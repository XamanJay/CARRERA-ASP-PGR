...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoEstimuloRec  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar   Tipo de Estimulo/Recococimiento</FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo Estimulo/Reconocimiento:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoEstimuloRec' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcTipoEstimuloRec%>>
		 <BR> <BR>
      </TD > 
</TABLE>
