...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcOjosTamano  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcOjosTamano")  <> "" then  Ob_RS("CARcOjosTamano")=request("CARcOjosTamano") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tamaño Ojos:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcOjosTamano' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcOjosTamano%>>
		 <BR> <BR>
      </TD > 
</TABLE>
