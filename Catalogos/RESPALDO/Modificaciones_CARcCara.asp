...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcCara  </FONT></h2>
     <BR>
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCara")  <> "" then  Ob_RS("CARcCara")=request("CARcCara") end if
    ...
    %>
 <TABLE width="509" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD> 
     </TR>
     <TR>
      <TD>
        <B>Tipo de Cara:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcCara' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcCara%>>
		 <BR> <BR>
      </TD > 
</TABLE>
