...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver Tipo de Boca  </FONT></h2>
     <BR>
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcBoca")  <> "" then  Ob_RS("CARcBoca")=request("CARcBoca") end if
    ...
    %>
 <TABLE width="656" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD> 
     </TR>
     <TR>
      <TD>
        <B>Tipo de Boca:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcBoca' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcBoca%>>
		 <BR> <BR>
      </TD > 
</TABLE>
