...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcMotivoAdscripcion.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Motivo de Adscripci&oacute;n   </FONT>
    </H2>
  </CENTER>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcMotivoAdscripcion.value  == "")
  {
