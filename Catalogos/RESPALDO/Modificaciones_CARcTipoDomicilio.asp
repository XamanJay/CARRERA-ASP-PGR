...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoDomicilio  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <TABLE width="455" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     ...
     <TR>
      <TD>
        <B>Tipo de Domicilio:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoDomicilio' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcTipoDomicilio%>>
		 <BR> <BR>
      </TD > 
</TABLE>
