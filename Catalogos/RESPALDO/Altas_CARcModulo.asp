...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcModulo.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Modulo   </FONT>
    </H2>
  </CENTER>
      ...
      <TD>
	     ...
	     <SELECT NAME='Id_CARcModulo' SIZE=1 >
          <% IF Id_CARcModulo = "" OR Id_CARcModulo = "0" THEN %>
           ...
           <% END IF  %>
	         <%DO UNTIL Ob_RS2.Eof%>
                <%IF Ob_RS2("Id_CARcModulo")= CINT(Id_CARcModulo) THEN %>
                   <OPTION SELECTED VALUE='<%=Ob_RS2("Id_CARcModulo")%>'> <%= Ob_RS2("CARcModulo")%>
                   </OPTION>
             <% ELSE  %>
