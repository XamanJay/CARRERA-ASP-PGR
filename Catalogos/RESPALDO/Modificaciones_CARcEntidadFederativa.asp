<%
   ...
   consulta = "SELECT * FROM CARcEntidadFederativa WHERE Id_CARcEntidadFederativa ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcEntidadFederativa= OB_RS("CARcEntidadFederativa")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEntidadFederativa.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcEntidadFederativa  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #990000>Modificar  CARcEntidadFederativa  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEntidadFederativa")  <> "" then  Ob_RS("CARcEntidadFederativa")=request("CARcEntidadFederativa") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Entidad Federativa:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEntidadFederativa' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcEntidadFederativa%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEntidadFederativa >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcEntidadFederativa.value  == "")
  {
       alert("EL CAMPO: Entidad Federativa, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcEntidadFederativa.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Entidad Federativa.");
       return false;
  }
