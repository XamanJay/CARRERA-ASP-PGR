<%
   ...
   consulta = "SELECT * FROM CARcTipoInstitucion WHERE Id_CARcTipoInstitucion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoInstitucion= OB_RS("CARcTipoInstitucion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoInstitucion.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoInstitucion  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Institución  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoInstitucion")  <> "" then  Ob_RS("CARcTipoInstitucion")=request("CARcTipoInstitucion") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Institución:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoInstitucion' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcTipoInstitucion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoInstitucion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoInstitucion.value  == "")
  {
       alert("EL CAMPO: Tipo de Institución, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoInstitucion.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo Institución.");
       return false;
  }
