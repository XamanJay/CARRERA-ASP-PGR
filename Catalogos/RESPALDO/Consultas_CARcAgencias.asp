...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Consultas de  Agencias   </FONT>
    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
    ...
    <% Ob_RS2.CLOSE%>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='CARcAgencias' SIZE=10 ROWS=1 COLS=35><%=CARcAgencias%></TEXTAREA>
      </TD > 
     <TR>
      <TD>
        <B>Numero estado</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
     ...
     <TR>
      <TD>
        <B>Area o Agencia</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='AreaoAgencia' SIZE=10 ROWS=1 COLS=35><%=AreaoAgencia%></TEXTAREA>
      </TD > 
     <TR>
      <TD>
        <B>Estado</font>	</B>
