...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoEvaluacion  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoEvaluacion")  <> "" then  Ob_RS("CARcTipoEvaluacion")=request("CARcTipoEvaluacion") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Evaluación:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoEvaluacion' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcTipoEvaluacion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
