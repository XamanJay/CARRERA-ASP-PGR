...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoCapacitacion  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Capacitación:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoCapacitacion' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcTipoCapacitacion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
