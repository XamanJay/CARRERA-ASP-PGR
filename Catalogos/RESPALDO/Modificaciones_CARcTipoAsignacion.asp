...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoAsignacion  </FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <TABLE width="366" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     ...
     <TR>
      <TD>
        <B>Tipo de Asignación:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoAsignacion' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcTipoAsignacion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
