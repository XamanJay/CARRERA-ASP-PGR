<%
   ...
   consulta = "SELECT * FROM CARcSubprocuradurias WHERE Id_CARcSubprocuradurias ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcSubprocuradurias= OB_RS("CARcSubprocuradurias")
   CARcSubDescripcion= OB_RS("CARcSubDescripcion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcSubprocuradurias.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcSubprocuradurias  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #990000>Modificar  CARcSubprocuradurias  </FONT></h2>
  <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcSubprocuradurias")  <> "" then  Ob_RS("CARcSubprocuradurias")=request("CARcSubprocuradurias") end if
        if request("CARcSubDescripcion")  <> "" then  Ob_RS("CARcSubDescripcion")=request("CARcSubDescripcion") end if
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcSubprocuradurias >
