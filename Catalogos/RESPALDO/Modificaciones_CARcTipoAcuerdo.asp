<%
   ...
   consulta = "SELECT * FROM CARcTipoAcuerdo WHERE Id_CARcTipoAcuerdo ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoAcuerdo= OB_RS("CARcTipoAcuerdo")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoAcuerdo.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcTipoAcuerdo  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Acuerdo  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoAcuerdo")  <> "" then  Ob_RS("CARcTipoAcuerdo")=request("CARcTipoAcuerdo") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Acuerdo:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoAcuerdo' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcTipoAcuerdo%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoAcuerdo >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoAcuerdo.value  == "")
  {
       alert("EL CAMPO: Tipo de Acuerdo, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoAcuerdo.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo Acuerdo.");
       return false;
  }
