...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcArmaFuego.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  ArmaFuego   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcArmaFuego")  <> "" then  Ob_RS("CARcArmaFuego")=UCASE(request("CARcArmaFuego")) end if
 ...
 <TABLE  border='1'   WIDTH='29%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>&iquest;Arma de Fuego?</font>	</B>
      </TD>
      <TD width="52%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcArmaFuego' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcArmaFuego%>>
      </TD > 
     </TR>
</TABLE>
