...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcAnteojos.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Anteojos   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcAnteojos")  <> "" then  Ob_RS("CARcAnteojos")=Ucase(request("CARcAnteojos")) end if
    ...
    %>
 <TABLE  border='1'   WIDTH='23%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="15%">     </TR>
     <TR>
      <TD>
        <B>&iquest;Anteojos?</font>	</B>
      </TD>
      <TD width="85%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcAnteojos' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcAnteojos%>>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcAnteojos.value  == "")
  {
