...
v_Tabla = "CARcComplexion"
   ...
   consulta = "SELECT * FROM CARcComplexion WHERE Id_CARcComplexion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcComplexion= OB_RS("CARcComplexion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcComplexion.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcComplexion")  <> "" then  Ob_RS("CARcComplexion")=UCASE(request("CARcComplexion")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcComplexion' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcComplexion%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcComplexion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcComplexion.value  == "")
  {
       alert("EL CAMPO: Complexión, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcComplexion.value.search("[^0-9]")  == 0 ) 
  {
