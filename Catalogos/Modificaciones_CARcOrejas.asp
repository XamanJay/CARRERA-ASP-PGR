...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  tipo de orejas</FONT></h2>
     <BR>
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcOrejas")  <> "" then  Ob_RS("CARcOrejas")=UCASE(request("CARcOrejas")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcOrejas' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcOrejas%>>
      </TD > 
</TABLE>
