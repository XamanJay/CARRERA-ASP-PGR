...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcCargoEstructura.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Cargo de Estructura   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcCargoEstructura")  <> "" then  Ob_RS("CARcCargoEstructura")=REPLACE(UCASE(request("CARcCargoEstructura")),"'","") end if
 ...
 <TABLE  border='1'   WIDTH='33%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="39%">     </TR>
     <TR>
      <TD>
        <B>Cargo de estructura</font>	</B>
      </TD>
      <TD width="61%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcCargoEstructura' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcCargoEstructura%>>
      </TD > 
     </TR>
</TABLE>
