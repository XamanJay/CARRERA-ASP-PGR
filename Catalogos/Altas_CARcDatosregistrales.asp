...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcDatosregistrales.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  datos registrables   </FONT>    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcDatosregistrales")  <> "" then  Ob_RS("CARcDatosregistrales")=REPLACE(UCASE(request("CARcDatosregistrales")),"'","") end if
 ...
 <TABLE  border='1'   WIDTH='29%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="53%">     </TR>
     <TR>
      <TD>
        <B>Datos registrables</font>	</B>
      </TD>
      <TD width="47%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcDatosregistrales' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcDatosregistrales%>>
      </TD > 
     </TR>
</TABLE>
