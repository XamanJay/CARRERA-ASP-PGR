...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcColorCabello.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Color de Cabello   </FONT>
    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   WIDTH='80%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Color de cabello</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcColorCabello' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcColorCabello%>>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcColorCabello.value  == "")
  {
