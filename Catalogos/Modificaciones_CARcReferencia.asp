...
v_Tabla = "CARcReferencia"
   ...
   consulta = "SELECT * FROM CARcReferencia WHERE Id_CARcReferencia ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcReferencia= OB_RS("CARcReferencia")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcReferencia.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Referencias</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Referencias  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcReferencia")  <> "" then  Ob_RS("CARcReferencia")=UCASE(request("CARcReferencia")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Referencia  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcReferencia' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcReferencia%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcReferencia >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcReferencia.value  == "")
  {
       alert("EL CAMPO: Referencia, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcReferencia.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Referencias Familiares.");
       return false;
  }
