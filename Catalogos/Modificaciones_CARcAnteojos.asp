...
v_Tabla = "CARcAnteojos"
   ...
   consulta = "SELECT * FROM CARcAnteojos WHERE Id_CARcAnteojos ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcAnteojos= OB_RS("CARcAnteojos")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcAnteojos.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcAnteojos  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #990000>Modificar  CARcAnteojos  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcAnteojos")  <> "" then  Ob_RS("CARcAnteojos")=request("CARcAnteojos") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Anteojos ?:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcAnteojos' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcAnteojos%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcAnteojos >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcAnteojos.value  == "")
  {
       alert("EL CAMPO: Anteojos ?, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcAnteojos.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Anteojos .");
       return false;
  }
