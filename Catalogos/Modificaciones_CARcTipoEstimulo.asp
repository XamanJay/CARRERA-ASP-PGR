...
v_Tabla = "CARcTipoEstimulo"
   ...
   consulta = "SELECT * FROM CARcTipoEstimulo WHERE Id_CARcTipoEstimulo ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoEstimulo= OB_RS("CARcTipoEstimulo")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoEstimulo.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Est&iacute;mulo </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Est&iacute;mulo  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoEstimulo")  <> "" then  Ob_RS("CARcTipoEstimulo")=request("CARcTipoEstimulo") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de est&iacute;mulo  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoEstimulo' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcTipoEstimulo%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoEstimulo >
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  if (FormEdita.Id_CARcTipoEstimulo.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo Estimulos.");
       return false;
  }
