...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Consultas de  Detalle de Est&iacute;mulo y Reconocimiento </FONT>    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcDetalle' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcDetalle%>>
      </TD > 
     <TR>
      <TD> 
