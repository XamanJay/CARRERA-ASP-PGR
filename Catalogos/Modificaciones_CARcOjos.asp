...
v_Tabla = "CARcOjos"
   ...
   consulta = "SELECT * FROM CARcOjos WHERE Id_CARcOjos ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcOjos.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Modificar tipos de OOos </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar tipos de Ojos  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcOjos")  <> "" then  Ob_RS("CARcOjos")=UCASE(request("CARcOjos")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcOjos' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcOjos%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcOjos >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcOjos.value  == "")
  {
       alert("EL CAMPO: Ojos, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcOjos.value.search("[^0-9]")  == 0 ) 
  {
