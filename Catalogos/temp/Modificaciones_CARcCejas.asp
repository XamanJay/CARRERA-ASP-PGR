...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCejas")  <> "" then  Ob_RS("CARcCejas")=request("CARcCejas") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcCejas' SIZE=10 MAXLENGTH=10 VALUE=<%= CARcCejas%>>
		 <BR> <BR>
      </TD > 
</TABLE>
