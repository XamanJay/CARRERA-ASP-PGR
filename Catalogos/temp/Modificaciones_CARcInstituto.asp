...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #990000>Ver CARcInstituto  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #990000>Modificar  CARcInstituto  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcInstituto")  <> "" then  Ob_RS("CARcInstituto")=request("CARcInstituto") end if
        Ob_RS.update
        response.clear
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Instituto:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcInstituto' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcInstituto%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  ...
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Instituto.");
       return false;
  }
