...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcNariz")  <> "" then  Ob_RS("CARcNariz")=request("CARcNariz") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcNariz' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcNariz%>>
		 <BR> <BR>
      </TD > 
</TABLE>
