...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcFrente")  <> "" then  Ob_RS("CARcFrente")=request("CARcFrente") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcFrente' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcFrente%>>
		 <BR> <BR>
      </TD > 
</TABLE>
