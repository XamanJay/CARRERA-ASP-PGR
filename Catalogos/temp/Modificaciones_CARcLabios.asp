...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcLabios")  <> "" then  Ob_RS("CARcLabios")=request("CARcLabios") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcLabios' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcLabios%>>
		 <BR> <BR>
      </TD > 
</TABLE>
