<%
   ...
   consulta = "SELECT * FROM CARcNivel WHERE Id_CARcNivel ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcNivel.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcNivel")  <> "" then  Ob_RS("CARcNivel")=request("CARcNivel") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcNivel' SIZE=25 MAXLENGTH=25 VALUE=<%= CARcNivel%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcNivel >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcNivel.value  == "")
  {
       alert("EL CAMPO: Nivel, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcNivel.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Nivel (Categoria).");
       return false;
  }
