...
v_Tabla = "CARcMotivoEstatus"
   ...
   consulta = "SELECT * FROM CARcMotivoEstatus WHERE Id_CARcMotivoEstatus ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcMotivoEstatus= OB_RS("CARcMotivoEstatus")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcMotivoEstatus.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Estatus de Motivo  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Estatus de Motivo  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcMotivoEstatus")  <> "" then  Ob_RS("CARcMotivoEstatus")=UCASE(request("CARcMotivoEstatus")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcMotivoEstatus' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcMotivoEstatus%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcMotivoEstatus >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcMotivoEstatus.value  == "")
  {
       alert("EL CAMPO: Motivo Estatus, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcMotivoEstatus.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Motivo Estatus.");
       return false;
  }
