...
v_Tabla = "CARcDatosregistrales"
   ...
   consulta = "SELECT * FROM CARcDatosregistrales WHERE Id_CARcDatosregistrales ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcDatosregistrales= OB_RS("CARcDatosregistrales")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcDatosregistrales.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Datos Registrables  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Datos Registrables  </FONT></h2>
     <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcDatosregistrales")  <> "" then  Ob_RS("CARcDatosregistrales")=UCASE(request("CARcDatosregistrales")) end if
    ...
    %>
 <TABLE width="343" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD> 
     </TR>
     <TR>
      <TD>
        <B>Datos registrables<BR>  
        </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcDatosregistrales' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcDatosregistrales%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcDatosregistrales >
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  if (FormEdita.Id_CARcDatosregistrales.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Datos Registrales.");
       return false;
  }
