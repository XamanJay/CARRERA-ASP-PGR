...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcDesempeno.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  desempe&ntilde;o   </FONT>    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    %>
 <TABLE  border='1'   WIDTH='25%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="15%">     </TR>
     <TR>
      <TD>
      ...
      <TD width="85%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcDesempeno' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcDesempeno%>>
      </TD > 
     </TR>
</TABLE>
