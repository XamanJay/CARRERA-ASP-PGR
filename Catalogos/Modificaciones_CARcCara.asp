...
v_Tabla = "CARcCara"
   ...
   consulta = "SELECT * FROM CARcCara WHERE Id_CARcCara ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcCara.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Cara</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Cara  </FONT></h2>
  <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCara")  <> "" then  Ob_RS("CARcCara")=UCASE(request("CARcCara")) end if
    ...
    %>
<center>
 <TABLE width="483" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD width="115">     </TR>
     <TR>
      <TD>
      ...
      <TD width="352">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcCara' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcCara%>>
      </TD > 
</TABLE>
</center>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcCara >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcCara.value  == "")
  {
       alert("EL CAMPO: Cara, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcCara.value.search("[^0-9]")  == 0 ) 
  {
