...
v_Tabla = "CARcLabios"
   ...
   consulta = "SELECT * FROM CARcLabios WHERE Id_CARcLabios ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcLabios.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcLabios")  <> "" then  Ob_RS("CARcLabios")=UCASE(request("CARcLabios")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcLabios' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcLabios%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcLabios >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcLabios.value  == "")
  {
       alert("EL CAMPO: Labios, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcLabios.value.search("[^0-9]")  == 0 ) 
  {
