...
v_Tabla = "CARcIdioma"
   ...
   consulta = "SELECT * FROM CARcIdioma WHERE Id_CARcIdioma ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcIdioma.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcIdioma")  <> "" then  Ob_RS("CARcIdioma")=UCASE(request("CARcIdioma")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Idioma o Dialecto </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcIdioma' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcIdioma%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcIdioma >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcIdioma.value  == "")
  {
       alert("EL CAMPO: Idioma o Dialecto, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcIdioma.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Idiomas.");
       return false;
  }
