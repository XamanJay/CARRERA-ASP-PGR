...
v_Tabla = "CARcColorCabello"
   ...
   consulta = "SELECT * FROM CARcColorCabello WHERE Id_CARcColorCabello ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcColorCabello= OB_RS("CARcColorCabello")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcColorCabello.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Color de Cabello</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Color de Cabello  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcColorCabello")  <> "" then  Ob_RS("CARcColorCabello")=UCASE(request("CARcColorCabello")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Color de cabello  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcColorCabello' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcColorCabello%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcColorCabello >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcColorCabello.value  == "")
  {
       alert("EL CAMPO: Color de cabello, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcColorCabello.value.search("[^0-9]")  == 0 ) 
  {
