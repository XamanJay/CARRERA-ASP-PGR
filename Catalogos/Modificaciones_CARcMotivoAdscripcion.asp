...
v_Tabla = "CARcMotivoAdscripcion"
   ...
   consulta = "SELECT * FROM CARcMotivoAdscripcion WHERE Id_CARcMotivoAdscripcion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcMotivoAdscripcion= OB_RS("CARcMotivoAdscripcion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcMotivoAdscripcion.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Motivo de Adscripción  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Motivo de Adscripci&oacute;n  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcMotivoAdscripcion")  <> "" then  Ob_RS("CARcMotivoAdscripcion")=request("CARcMotivoAdscripcion") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Motivo adscripción<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcMotivoAdscripcion' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcMotivoAdscripcion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcMotivoAdscripcion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcMotivoAdscripcion.value  == "")
  {
       alert("EL CAMPO: Motivo Adscripción, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcMotivoAdscripcion.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Motivo Adscripción.");
       return false;
  }
