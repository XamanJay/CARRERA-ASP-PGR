...
v_Tabla = "CARcEspecialidad"
   ...
   consulta = "SELECT * FROM CARcEspecialidad WHERE Id_CARcEspecialidad ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcEspecialidad= OB_RS("CARcEspecialidad")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEspecialidad.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Especialidad  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Especialidad  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEspecialidad")  <> "" then  Ob_RS("CARcEspecialidad")=UCASE(request("CARcEspecialidad")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEspecialidad' SIZE=40 MAXLENGTH=40 style="text-transform: uppercase" VALUE=<%= CARcEspecialidad%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEspecialidad >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcEspecialidad.value  == "")
  {
       alert("EL CAMPO: Especialidad, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcEspecialidad.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catalogo Especialidad.");
       return false;
  }
