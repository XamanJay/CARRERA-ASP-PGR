...
v_Tabla = "CARcEdoCivil"
   ...
   consulta = "SELECT * FROM CARcEdoCivil WHERE Id_CARcEdoCivil ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcEdoCivil= OB_RS("CARcEdoCivil")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEdoCivil.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Estado Civil  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Estado Civil  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEdoCivil")  <> "" then  Ob_RS("CARcEdoCivil")=UCASE(request("CARcEdoCivil")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEdoCivil' SIZE=25 MAXLENGTH=25 style="text-transform: uppercase" VALUE=<%= CARcEdoCivil%>>
      </TD > 
     <TR>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEdoCivil >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcEdoCivil.value  == "")
  {
       alert("EL CAMPO: Estado Civil, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcEdoCivil.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Estado Civil.");
       return false;
  }
