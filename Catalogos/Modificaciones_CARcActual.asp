...
v_Tabla = "CARcActual"
   ...
   consulta = "SELECT * FROM CARcActual WHERE Id_CARcActual ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcActual.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcActual")  <> "" then  Ob_RS("CARcActual")=request("CARcActual") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcActual' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcActual%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcActual >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcActual.value  == "")
  {
       alert("EL CAMPO: Actual ?, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcActual.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catalogo Actual ?.");
       return false;
  }
