...
v_Tabla = "CARcTipoEstimuloRec"
   ...
   consulta = "SELECT * FROM CARcTipoEstimuloRec WHERE Id_CARcTipoEstimuloRec ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoEstimuloRec= OB_RS("CARcTipoEstimuloRec")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoEstimuloRec.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver   Tipo de est&iacute;mulo/Recococimiento</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar   Tipo de est&iacute;mulo/Recococimiento</FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoEstimuloRec")  <> "" then  Ob_RS("CARcTipoEstimuloRec")=request("CARcTipoEstimuloRec") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoEstimuloRec' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcTipoEstimuloRec%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoEstimuloRec >
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  ...
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Estimulo/Reconocimiento.");
       return false;
  }
