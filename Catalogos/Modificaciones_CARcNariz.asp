...
v_Tabla = "CARcNariz"
   ...
   consulta = "SELECT * FROM CARcNariz WHERE Id_CARcNariz ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcNariz.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcNariz")  <> "" then  Ob_RS("CARcNariz")=UCASE(request("CARcNariz")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcNariz' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcNariz%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcNariz >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcNariz.value  == "")
  {
       alert("EL CAMPO: Nariz, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcNariz.value.search("[^0-9]")  == 0 ) 
  {
