...
v_Tabla = "CARcOjosTamano"
   ...
   consulta = "SELECT * FROM CARcOjosTamano WHERE Id_CARcOjosTamano ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcOjosTamano= OB_RS("CARcOjosTamano")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcOjosTamano.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver</FONT><FONT COLOR= #3366CC>  Tama&ntilde;o de Ojos</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tama&ntilde;o de Ojos </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcOjosTamano")  <> "" then  Ob_RS("CARcOjosTamano")=UCASE(request("CARcOjosTamano")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tamaño ojos  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcOjosTamano' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcOjosTamano%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcOjosTamano >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcOjosTamano.value  == "")
  {
       alert("EL CAMPO: Tamaño Ojos, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcOjosTamano.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Tamaño Ojos.");
       return false;
  }
