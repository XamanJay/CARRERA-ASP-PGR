...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcCategoria.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Categor&iacute;a   </FONT>    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcCategoria")  <> "" then  Ob_RS("CARcCategoria")=REPLACE(UCASE(request("CARcCategoria")),"'","") end if
    ...
    %>
 <TABLE  border='1'   WIDTH='35%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="13%">     </TR>
     <TR>
      <TD>
        <B>Categor&iacute;a</font>	</B>
      </TD>
      <TD width="87%">
 	   <P ALIGN='left'>
       <TEXTAREA style='text-transform: uppercase' NAME='CARcCategoria' SIZE=10 ROWS=5 COLS=35><%=CARcCategoria%></TEXTAREA>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcCategoria.value  == "")
  {
