...
v_Tabla = "CARcTipoNombramiento"
   ...
   consulta = "SELECT * FROM CARcTipoNombramiento WHERE Id_CARcTipoNombramiento ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoNombramiento= OB_RS("CARcTipoNombramiento")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoNombramiento.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Nombramiento </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Nombramiento  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoNombramiento")  <> "" then  Ob_RS("CARcTipoNombramiento")=UCASE(request("CARcTipoNombramiento")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Nombraiento:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <TEXTAREA NAME='CARcTipoNombramiento' SIZE=10 ROWS=5 COLS=35 style="text-transform: uppercase"><%=CARcTipoNombramiento%></TEXTAREA>
  	<BR><BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoNombramiento >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoNombramiento.value  == "")
  {
       alert("EL CAMPO: Tipo de Nombraiento, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoNombramiento.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo Nombramiento.");
       return false;
  }
