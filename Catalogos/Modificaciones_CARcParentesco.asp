...
v_Tabla = "CARcParentesco"
   ...
   consulta = "SELECT * FROM CARcParentesco WHERE Id_CARcParentesco ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcParentesco= OB_RS("CARcParentesco")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcParentesco.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcParentesco")  <> "" then  Ob_RS("CARcParentesco")=UCASE(request("CARcParentesco")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Parentesco  </font>	</B>      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcParentesco' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcParentesco%>>
      </TD > 
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcParentesco >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcParentesco.value  == "")
  {
       alert("EL CAMPO: Parentesco, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcParentesco.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Parentesco.");
       return false;
  }
