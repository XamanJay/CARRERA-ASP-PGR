...
v_Tabla = "CarcBoca"
   ...
   consulta = "SELECT * FROM CarcBoca WHERE Id_CarcBoca ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CarcBoca.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Boca</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Boca  </FONT></h2>
  <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcBoca")  <> "" then  Ob_RS("CARcBoca")=UCASE(request("CARcBoca")) end if
    ...
    %>
	<center>
 <TABLE width="493" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD>
        <B>Tipo de Boca</B></TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcBoca' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcBoca%>>
		 <BR> <BR>
      </TD > 
	  </TR>
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CarcBoca >
...
function ValidaCampos()
{
  ...
  if (FormEdita.Id_CARcBoca.value  == "")
  {
       alert("EL CAMPO: TI_Boca, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.CARcBoca.value  == "")
  {
       alert("EL CAMPO: Boca, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcBoca.value.search("[^0-9]")  == 0 ) 
  {
