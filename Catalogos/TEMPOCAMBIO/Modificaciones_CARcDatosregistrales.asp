...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcDatosregistrales")  <> "" then  Ob_RS("CARcDatosregistrales")=request("CARcDatosregistrales") end if
 ...
 <TABLE width="343" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     ...
     <TR>
      <TD>
        <B>Datos Registrables:<BR>  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcDatosregistrales' SIZE=15 MAXLENGTH=15 VALUE=<%= CARcDatosregistrales%>>
		 <BR> <BR>
      </TD > 
</TABLE>
