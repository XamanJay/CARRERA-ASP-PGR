...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CarcBoca.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de Tipo de Boca   </FONT>
    </H2>
  </CENTER>
 ...
 <TABLE  border='1'   WIDTH='80%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de Boca</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcBoca' SIZE=50 MAXLENGTH=50 VALUE=<%= CARcBoca%>>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.Id_CARcBoca.value  == 0 )
  {
       alert("EL CAMPO: TI_Boca, no puede estar vacio");
       return false;
  }
  
  if (FormAltas.CARcBoca.value  == "")
  {
