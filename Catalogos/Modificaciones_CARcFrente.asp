...
v_Tabla = "CARcFrente"
   ...
   consulta = "SELECT * FROM CARcFrente WHERE Id_CARcFrente ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcFrente.asp" NAME= "FormEdita">
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcFrente")  <> "" then  Ob_RS("CARcFrente")=UCASE(request("CARcFrente")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcFrente' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcFrente%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcFrente >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcFrente.value  == "")
  {
       alert("EL CAMPO: frente, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcFrente.value.search("[^0-9]")  == 0 ) 
  {
