...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcEspecialidad.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  especialidad   </FONT>    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    %>
 <TABLE  border='1'   WIDTH='44%' ID='AutoNumber1' HEIGHT='0'>
     <TR>
      <TD width="25%">     </TR>
     <TR>
      <TD>
      ...
      <TD width="75%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' style='text-transform: uppercase' NAME='CARcEspecialidad' SIZE=40 MAXLENGTH=40 VALUE=<%= CARcEspecialidad%>>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcEspecialidad.value  == "")
  {
