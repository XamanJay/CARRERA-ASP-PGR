...
v_Tabla = "CARcTipoAsignacion"
   ...
   consulta = "SELECT * FROM CARcTipoAsignacion WHERE Id_CARcTipoAsignacion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoAsignacion= OB_RS("CARcTipoAsignacion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoAsignacion.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver</FONT><FONT COLOR= #3366CC>  Tipo de Asignaci&oacute;n </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Asignaci&oacute;n  </FONT></h2>
     <p ALIGN="center"> &nbsp;
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoAsignacion")  <> "" then  Ob_RS("CARcTipoAsignacion")=request("CARcTipoAsignacion") end if
    ...
    %>
 <TABLE width="366" HEIGHT='0'  border='1'   ID='AutoNumber1'>
     <TR>
      <TD> 
     </TR>
     <TR>
      <TD>
        <B>Tipo de asignación  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoAsignacion' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcTipoAsignacion%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoAsignacion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoAsignacion.value  == "")
  {
       alert("EL CAMPO: Tipo Asignación, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoAsignacion.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catalogo Tipo Asignación.");
       return false;
  }
