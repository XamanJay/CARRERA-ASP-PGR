...
v_Tabla = "CARcEstatusPlaza"
   ...
   consulta = "SELECT * FROM CARcEstatusPlaza WHERE Id_CARcEstatusPlaza ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcEstatusPlaza= OB_RS("CARcEstatusPlaza")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEstatusPlaza.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Estatus de Plaza  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Estatus de Plaza  </FONT></h2>
  <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEstatusPlaza")  <> "" then  Ob_RS("CARcEstatusPlaza")=UCASE(request("CARcEstatusPlaza")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Descripción estatus </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEstatusPlaza' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcEstatusPlaza%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEstatusPlaza >
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  if (FormEdita.Id_CARcEstatusPlaza.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catalogo Estatus Plaza.");
       return false;
  }
