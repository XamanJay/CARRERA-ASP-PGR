...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Resultado de Evaluaciones</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Resultado de Evaluaciones</FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Resultado evaluación  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcResultadoEva' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcResultadoEva%>>
      </TD > 
</TABLE>
...
function ValidaCampos()
{
  ...
  {
       alert("EL CAMPO: Resultado Evaluación, no puede estar vacio");
       return false;
  }
