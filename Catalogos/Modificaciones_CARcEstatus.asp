...
v_Tabla = "CARcEstatus"
   ...
   consulta = "SELECT * FROM CARcEstatus WHERE Id_CARcEstatus ="+CSTR(ParID) 
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcEstatus.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Estatus  de Estudios </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Estatus de Estudios </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcEstatus")  <> "" then  Ob_RS("CARcEstatus")=request("CARcEstatus") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Estatus de estudio</font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcEstatus' SIZE=15 MAXLENGTH=15 style="text-transform: uppercase" VALUE=<%= CARcEstatus%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcEstatus >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcEstatus.value  == "")
  {
       alert("EL CAMPO: Estatus Estudio, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcEstatus.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Estatus Estudios.");
       return false;
  }
