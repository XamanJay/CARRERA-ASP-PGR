...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Altas_CARcTipoAsignacion.asp" NAME= "FormAltas">
        <input type="hidden" name="Agregar" value="S">

  
  <CENTER>
    <H2> 
     <FONT COLOR= #3366CC>Altas de  Tipo de Asignaci&oacute;n   </FONT>
    </H2>
  </CENTER>
 ...
 <!--- insertar resultado de  LOOP ----------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vAgregar = "S" then  
    	   Ob_RS.Addnew 
        if request("CARcTipoAsignacion")  <> "" then  Ob_RS("CARcTipoAsignacion")=UCASE(request("CARcTipoAsignacion")) end if
 ...
 <TABLE  border='1'   WIDTH='80%' ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      ...
      <TD width="68%">
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT'  style='text-transform: uppercase'  NAME='CARcTipoAsignacion' SIZE=20 MAXLENGTH=20 VALUE=<%= CARcTipoAsignacion%>>
      </TD > 
     </TR>
</TABLE>
...
function ValidaCampos()
{
  ...
  if (FormAltas.CARcTipoAsignacion.value  == "")
  {
