...
v_Tabla = "CARcTipoCapacitacion"
   ...
   consulta = "SELECT * FROM CARcTipoCapacitacion WHERE Id_CARcTipoCapacitacion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoCapacitacion= OB_RS("CARcTipoCapacitacion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoCapacitacion.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver</FONT><FONT COLOR= #3366CC>  Tipo de Capacitaci&oacute;n</FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Capacitaci&oacute;n  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoCapacitacion")  <> "" then  Ob_RS("CARcTipoCapacitacion")=request("CARcTipoCapacitacion") end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de capacitación  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoCapacitacion' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcTipoCapacitacion%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoCapacitacion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoCapacitacion.value  == "")
  {
       alert("EL CAMPO: Tipo de Capacitación, no puede estar vacio");
       return false;
  }
  
  if (FormEdita.Id_CARcTipoCapacitacion.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo de Capacitación.");
       return false;
  }
