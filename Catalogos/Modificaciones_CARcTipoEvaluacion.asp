...
v_Tabla = "CARcTipoEvaluacion"
   ...
   consulta = "SELECT * FROM CARcTipoEvaluacion WHERE Id_CARcTipoEvaluacion ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcTipoEvaluacion= OB_RS("CARcTipoEvaluacion")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcTipoEvaluacion.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver  Tipo de Evaluaci&oacute;n </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Tipo de Evaluaci&oacute;n  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcTipoEvaluacion")  <> "" then  Ob_RS("CARcTipoEvaluacion")=UCASE(request("CARcTipoEvaluacion")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Tipo de evaluación  </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcTipoEvaluacion' SIZE=50 MAXLENGTH=50 style="text-transform: uppercase" VALUE=<%= CARcTipoEvaluacion%>>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcTipoEvaluacion >
...
function ValidaCampos()
{
  ...
  if (FormEdita.CARcTipoEvaluacion.value  == "")
  {
  ...
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catálogo Tipo de Evaluacion.");
       return false;
  }
