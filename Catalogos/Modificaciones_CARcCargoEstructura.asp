...
v_Tabla = "CARcCargoEstructura"
   ...
   consulta = "SELECT * FROM CARcCargoEstructura WHERE Id_CARcCargoEstructura ="+CSTR(ParID) 
...
'======= Inicializa variables de ambiente ===========
   CARcCargoEstructura= OB_RS("CARcCargoEstructura")
...
<link href="Estilo.css" rel="stylesheet" type="text/css">
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <CENTER>
  <FORM METHOD="post" ACTION= "Modificaciones_CARcCargoEstructura.asp" NAME= "FormEdita">
...
TOper = REQUEST("TOper")
 IF TOper = "VER" then%>
    <H2><FONT COLOR= #3366CC>Ver Cargo de Estructura  </FONT></h2>
     <BR>
    <INPUT TYPE="button" VALUE="Ver otro registro" ONCLICK="location.href='javascript:window.history.back()'   " >
<% ELSE %>
     <H2><FONT COLOR= #3366CC>Modificar  Cargo de Estructura  </FONT></h2>
     <p ALIGN="center"> &nbsp;
...
<%END IF %> 
 ...
 <!--- insertar resulstado de  LOOP ----------------------------------------------------------------------------------------------- --->
    ...
    <% 
     ...
     if vModi = "S" then  
        ...
        if request("CARcCargoEstructura")  <> "" then  Ob_RS("CARcCargoEstructura")=UCASE(request("CARcCargoEstructura")) end if
 ...
 <TABLE  border='1'   ID='AutoNumber1' HEIGHT='0'>
     ...
     <TR>
      <TD>
        <B>Cargo de estructura<BR>  
        </font>	</B>
      </TD>
      <TD>
 	   <P ALIGN='left'>
       <INPUT TYPE='TEXT' NAME='CARcCargoEstructura' SIZE=20 MAXLENGTH=20 style="text-transform: uppercase" VALUE=<%= CARcCargoEstructura%>>
		 <BR> <BR>
      </TD > 
</TABLE>
...
<INPUT TYPE="Hidden" NAME=tabla_original Value = CARcCargoEstructura >
...
function ValidaCampos()
{
 ...
 // no Tiene Campos Obligatorios 
  if (FormEdita.Id_CARcCargoEstructura.value.search("[^0-9]")  == 0 ) 
  {
       alert(" Debe seleccionar una opcion en EL CAMPO: Catalogo Cargo de Estructura.");
       return false;
  }
