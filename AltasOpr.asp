...
<%
 v_Id_llaveSQL_ClavePuesto = REQUEST.FORM("Id_SFPcPuestos")

 var_pstabla = Request.Form("tabla_original")
 var_psODBC = Request.Form("ODBC")
 var_pagina_catalogo = Request.Form("catalogo")
 idPersona = request.form("cbxCARdDatosPersonales")
 mOper = Request.Form ("mOper")
 mOper2 = Request.Form ("mOper2")
...
<%
 var_pagina_regreso = "'Altas_"+ TRIM(var_pstabla)  +".asp?Id_CARdDatosPersonales="+ idPersona +"&oper="+mOper+"&IDTabla2="+mOper2+"'"
%>
