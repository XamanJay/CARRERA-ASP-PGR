...
<form action="GRECA_crea_menu_II.asp" method="post" name="greca_menu2" >
  <img src='Multimedia/imagenes/menus/circulo01.gif'><strong><font size="4">Reportes</font></strong> 
  <p style='margin-left: -1; margin-right: -1'>
<div class='look'><img src='Multimedia/imagenes/menus/circulo.gif' class='folding' width='10' height='10'><a target='mainFrame' href='https://<%= session("IP_SERVER")%>/carrerapgr/Reportes/CAP_Filtros_reportes.asp'>Reporte de personal inscrito</a></td><hr></div><p style='margin-left: -1; margin-right: -1'>
