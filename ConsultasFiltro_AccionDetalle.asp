...
<HTML>
 ...
 <BODY BGPROPERTIES="fixed" BACKGROUND="softgri1.jpg" TOPMARGIN="0" LEFTMARGIN="0">
  ...
  <FORM METHOD="post" ACTION="DosMarcos_ConsultasFiltroAccion.asp" NAME= "FormVehiModificaciones" >
...
<!--      Modificaciones de ---> <% 'RESPONSE.WRITE (titulo)%>
		  Detalle de la consulta de registros
     </H3>
    </B>
   </LEGEND>
  <Table>
...
<INPUT TYPE="Hidden" NAME=Id_RegistroSeleccionado Value = "<%= Ob_RS(0)%>" >
<INPUT TYPE="Hidden" NAME=RegistroSeleccionado Value = "<%= Ob_RS(1)%>" >
...
<!---  <INPUT TYPE="submit" VALUE="Actualizar" NAME="B1"> &nbsp;&nbsp;&nbsp; --->
  <INPUT TYPE="button" VALUE="Dirigido a" NAME="B1" ONCLICK="location.href='DosMarcos_ConsultasFiltroAccion.asp'"> 
